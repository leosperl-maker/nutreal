    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <p className="font-medium text-gray-800 text-sm truncate">{exercise.name}</p>
      ...
      {expanded && (
        <motion.div
          ...
          className="px-3 pb-3 border-t border-gray-50"
        >
    ...
    >
      <div className="p-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            onClick={onStart}
            className="w-12 h-12 rounded-full bg-primary-500 text-white flex items-center justify-center shadow-md hover:bg-primary-600 active:scale-95 transition-all"
          >
            ...
            <div>
              ...
              <div className="space-y-1.5">
                {session.warmup.map((ex, i) => (
                  <div key={ex.id} className="flex items-center gap-2 text-xs text-gray-500 bg-orange-50 rounded-lg px-3 py-2">
            ...
            <div>
              ...
              <div className="space-y-1.5">
                {session.cooldown.map((ex, i) => (
                  <div key={ex.id} className="flex items-center gap-2 text-xs text-gray-500 bg-green-50 rounded-lg px-3 py-2">
