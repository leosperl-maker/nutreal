...
export default function WorkoutHistory({ workouts, weeklyStats, streak }: Props) {
  ...
  return (
    <div className="space-y-4">
      {/* Weekly Stats */}
      <div className="bg-gradient-to-br from-primary-500/10 to-purple-500/10 rounded-2xl p-4 border border-primary-500/20">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-white rounded-xl p-3 text-center">
            ...
            <p className="text-xs text-gray-400">kcal brûlées</p>
          </div>
          <div className="bg-white rounded-xl p-3 text-center">
            <p className="text-2xl font-bold text-blue-500">{weeklyStats.totalMinutes}</p>
            <p className="text-xs text-gray-400">minutes</p>
          </div>
          <div className="bg-white rounded-xl p-3 text-center">
            <p className="text-lg font-bold text-gray-700">{weeklyStats.avgFeeling}</p>
